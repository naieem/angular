                                    ...
                                    if ($portfolio_m_images) {
                                        ...
                                        foreach ($portfolio_image_gallery_array as $gimg_id) {
                                            ...
                                            <?php if ($lightbox_single_project == "yes") { ?>
                                                <a class="lightbox_single_portfolio" title="<?php echo $title; ?>"
                                    ...
                                    if ($portfolio_images) {
                                        ...
                                        foreach ($portfolio_images as $portfolio_image) {
                                            ...
                                            <?php if ($portfolio_image['portfolioimg'] != "") { ?>
                                                ...
                                                <?php if ($lightbox_single_project == "yes") { ?>
                                                    <a class="lightbox_single_portfolio" title="<?php echo $title; ?>"
                                                       href="<?php echo stripslashes($portfolio_image['portfolioimg']); ?>"
                                                       data-rel="prettyPhoto[single_pretty_photo]">
                                                        <img
                                                            src="<?php echo stripslashes($portfolio_image['portfolioimg']); ?>"
                                                            alt="<?php echo $alt; ?>"/>
                                                    </a>
                                                <?php } else { ?>
                                                    <img
                                                ...
                                                switch ($portfoliovideotype) {
                                                    case "youtube": ?>
                                                        <?php if ($lightbox_video_single_project == "yes") { ?>
                                                            ...
                                                            ?>
                                                            <a class="lightbox_single_portfolio video_in_lightbox"
                                                               title="<?php echo $video_title; ?>"
                                                               href="<?php echo $protocol; ?>//www.youtube.com/watch?feature=player_embedded&v=<?php echo $vidID; ?>"
                                                        ...
                                                        <?php } else { ?>
                                                            <iframe width="100%"
                                                                    src="//www.youtube.com/embed/<?php echo $portfolio_image['portfoliovideoid']; ?>?wmode=transparent"
                                                                    wmode="Opaque" frameborder="0"
                                                    ...
                                                    case "vimeo": ?>
                                                        <?php if ($lightbox_video_single_project == "yes") { ?>
                                                            ...
                                                            <a class="lightbox_single_portfolio video_in_lightbox"
                                                               title="<?php echo $video_title; ?>"
                                                               href="<?php echo $protocol; ?>//vimeo.com/<?php echo $vidID; ?>"
                                                               rel="prettyPhoto[single_pretty_photo]">
                                                                <i class="fa fa-play"></i>
                                                                <img width="100%" src="<?php echo $thumbnail; ?>"></img>
                                                            </a>
                                                        <?php } else { ?>
                                                            <iframe
                                                                src="//player.vimeo.com/video/<?php echo $portfolio_image['portfoliovideoid']; ?>?title=0&amp;byline=0&amp;portrait=0"
                                                    ...
                                                    case "self": ?>
                                                        <div class="video">
                                                            <div class="mobile-video-image"
                                                                 style="background-image: url(<?php echo $portfolio_image['portfoliovideoimage']; ?>);"></div>
                                                            <div class="video-wrap">
                                                                <video class="video"
                                                                       poster="<?php echo $portfolio_image['portfoliovideoimage']; ?>"
                                                                       preload="auto">
                                                                    <?php if (!empty($portfolio_image['portfoliovideowebm'])) { ?>
                                                                        <source type="video/webm"
                                                                                src="<?php echo $portfolio_image['portfoliovideowebm']; ?>"> <?php } ?>
                                                                    <?php if (!empty($portfolio_image['portfoliovideomp4'])) { ?>
                                                                        <source type="video/mp4"
                                                                                src="<?php echo $portfolio_image['portfoliovideomp4']; ?>"> <?php } ?>
                                                                    <?php if (!empty($portfolio_image['portfoliovideoogv'])) { ?>
                                                                        <source type="video/ogg"
                                                                                src="<?php echo $portfolio_image['portfoliovideoogv']; ?>"> <?php } ?>
                                                                    <object width="320" height="240"
                                                                            type="application/x-shockwave-flash"
                                                                            data="<?php echo get_template_directory_uri(); ?>/js/flashmediaelement.swf">
                                                                        <param name="movie"
                                                                               value="<?php echo get_template_directory_uri(); ?>/js/flashmediaelement.swf"/>
                                                                        <param name="flashvars"
                                                                               value="controls=true&file=<?php echo $portfolio_image['portfoliovideomp4']; ?>"/>
                                                                        <img
                                                                            src="<?php echo $portfolio_image['portfoliovideoimage']; ?>"
                                ...
                                <div class="portfolio_detail <?php echo $portfolio_text_follow; ?> clearfix">
                                    ...
                                    <div class="portfolio_social_holder">
                                        ...
                                        <?php if ($portfolio_qode_like == "on") { ?>
                                            ...
                                            <div
                                                class="portfolio_like"><?php if (function_exists('qode_like')) qode_like(); ?></div>
                                        <?php } ?>
                                    </div>
                                </div>
                            </div>
                            ...
                            if ($portfolio_images) {
                                foreach ($portfolio_images as $portfolio_image) {
                                    ...
                                    <?php if ($portfolio_image['portfolioimg'] != "") { ?>
                                        ...
                                        ?>
                                        <li class="slide">
                                            <img src="<?php echo stripslashes($portfolio_image['portfolioimg']); ?>"
                                                 alt="<?php echo $alt; ?>"/>
                                        </li>
                                    <?php } else { ?>
                    ...
                    <div class="portfolio_images">
                        ...
                        if ($portfolio_m_images) {
                            ...
                            foreach ($portfolio_image_gallery_array as $gimg_id) {
                                ...
                                <?php if ($lightbox_single_project == "yes") { ?>
                                    <a class="lightbox_single_portfolio" title="<?php echo $title; ?>"
                                       href="<?php echo $image_src; ?>" data-rel="prettyPhoto[single_pretty_photo]">
                                        <img src="<?php echo $image_src; ?>" alt="<?php echo $alt; ?>"/>
                                    </a>
                                <?php } else { ?>
                                    <img src="<?php echo $image_src; ?>" alt="<?php echo $alt; ?>"/>
                            ...
                            foreach ($portfolio_image_gallery_array as $gimg_id) {
                                ...
                                <?php if ($lightbox_single_project == "yes") { ?>
                                    <a class="lightbox_single_portfolio <?php echo $columns_number; ?>"
                                       title="<?php echo $title; ?>" href="<?php echo $original_img; ?>"
                                       data-rel="prettyPhoto[single_pretty_photo]">
                                        <span class="gallery_text_holder"><span
                                                class="gallery_text_inner"><h6><?php echo $title; ?></h6></span></span>
                                        <img src="<?php echo $image_src; ?>" alt="<?php echo $alt; ?>"/>
                                    </a>
                                <?php } else { ?>
                        ...
                        if ($portfolio_images) {
                            ...
                            foreach ($portfolio_images as $portfolio_image) {
                                ...
                                <?php if ($portfolio_image['portfolioimg'] != "") { ?>
                                    ...
                                    <?php if ($lightbox_single_project == "yes") { ?>
                                        <a class="lightbox_single_portfolio <?php echo $columns_number; ?>"
                                           title="<?php echo $portfolio_image['portfoliotitle']; ?>"
                                           href="<?php echo stripslashes($portfolio_image['portfolioimg']); ?>"
                                           data-rel="prettyPhoto[single_pretty_photo]">
                                            <span class="gallery_text_holder"><span
                                                    class="gallery_text_inner"><h6><?php echo $portfolio_image['portfoliotitle']; ?></h6></span></span>
                                            <img src="<?php echo stripslashes($portfolio_image['portfolioimg']); ?>"
                                                 alt="<?php echo $alt; ?>"/>
                                        </a>
                                    <?php } else { ?>
                                    ...
                                    switch ($portfoliovideotype) {
                                        case "youtube": ?>
                                            <?php if ($lightbox_single_project == "yes") { ?>
                                                <a class="lightbox_single_portfolio <?php echo $columns_number; ?>"
                                                   title="<?php echo $portfolio_image['portfoliotitle']; ?>"
                                                   href="<?php echo $protocol; ?>//www.youtube.com/watch?feature=player_embedded&v=<?php echo $portfolio_image['portfoliovideoid']; ?>"
                                                   rel="prettyPhoto[single_pretty_photo]">
                                                    <span class="gallery_text_holder"><span
                                                            class="gallery_text_inner"><h6><?php echo $portfolio_image['portfoliotitle']; ?></h6></span></span>
                                                    <img width="100%"
                                                         src="//img.youtube.com/vi/<?php echo $portfolio_image['portfoliovideoid']; ?>/maxresdefault.jpg"/>
                                                </a>
                                            <?php } else { ?>
                                                <a class="lightbox_single_portfolio <?php echo $columns_number; ?>"
                                                   href="#">
                                        ...
                                        case "vimeo": ?>
                                            <?php if ($lightbox_single_project == "yes") {
                                                ...
                                                <a class="lightbox_single_portfolio <?php echo $columns_number; ?>"
                                                   title="<?php echo $portfolio_image['portfoliotitle']; ?>"
                                                   href="<?php echo $protocol; ?>//vimeo.com/<?php echo $portfolio_image['portfoliovideoid']; ?>"
                                                   rel="prettyPhoto[single_pretty_photo]">
                                                    <span class="gallery_text_holder"><span
                                                            class="gallery_text_inner"><h6><?php echo $portfolio_image['portfoliotitle']; ?></h6></span></span>
