...
if (get_post_meta($page_id, 'qode_content_bottom_sidebar_in_grid', true) != "") {
    ...
    if (isset($qode_options_proya['content_bottom_in_grid'])) {
        if ($qode_options_proya['content_bottom_in_grid'] == "no")
            $content_bottom_area_in_grid = false;
    }
}
